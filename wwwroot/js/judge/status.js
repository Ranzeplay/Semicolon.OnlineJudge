...
connection.on('updateStatus', function (data) {
    ...
    switch (originalData.Status) {
        ...
        case 1:
            ...
            break;
        case 2:
            document.getElementById('status').innerText = 'Compile Error';
            break;
        case 3:
            document.getElementById('status').innerText = 'Unkonwn Error';
            break;
        case 4:
...
connection.on('finish', function () {
    ...
    document.getElementById('server-status').innerHTML = 'Finished';
});
